...
<div class="max-w-4xl mx-auto px-4 py-12 min-h-[60vh]">
    ...
    {{-- Top Back Link --}}
    <div class="mb-8">
        <a href="{{ route('welcome') }}" class="text-red-600 hover:text-red-800 font-bold flex items-center transition-colors">
            <i class="fas fa-arrow-left mr-2"></i> Back to Home
        </a>
    </div>

    <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white mb-2">Terms of Service</h1>
    <p class="text-gray-500 dark:text-gray-400 mb-8">Last updated: {{ date('F Y') }}</p>

    <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-6">
        <section>
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">1. Acceptance of Terms</h3>
        ...
        <section>
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">2. Services</h3>
        ...
        <section>
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">3. User Accounts</h3>
        ...
        <section>
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">4. Orders & Payments</h3>
    ...
    <div class="mt-12 pt-8 border-t border-gray-100 dark:border-gray-800">
        <a href="{{ route('welcome') }}" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-bold rounded-full text-white bg-red-600 hover:bg-red-700 transition-transform transform hover:-translate-y-0.5 shadow-md">
