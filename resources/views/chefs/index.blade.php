...
<div class="container py-5">
    <div class="row mb-5">
        <div class="col-md-8 mx-auto text-center">
            ...
            <form action="{{ route('chefs.index') }}" method="GET" class="d-flex gap-2 justify-content-center">
            ...
            <div class="mt-3 d-flex justify-content-center flex-wrap gap-2">
                <a href="{{ route('chefs.index') }}" class="badge rounded-pill bg-dark text-decoration-none p-2">All</a>
                @foreach($cuisines as $cuisine)
                    <a href="{{ route('chefs.index', ['cuisine' => $cuisine->slug]) }}" 
    ...
    <div class="row g-4">
        ...
        @empty
            <div class="col-12 text-center py-5">
                ...
                <a href="{{ route('chefs.index') }}" class="btn btn-outline-primary mt-2">Clear Filters</a>
            </div>
        @endforelse
    </div>
